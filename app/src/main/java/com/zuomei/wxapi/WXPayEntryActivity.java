...
/*	@ViewInject(R.id.top_back)
	...
	public void onResp(BaseResp resp) {
		...
		if(resp.errCode==0){
			...
			String ss = BaseApplication.aCache.getAsString(MLConstants.ACACHE_PARAM_WX_SHOP);
	...
	private void requestPayShop(){
		...
		ZMHttpRequestMessage message1 = new ZMHttpRequestMessage(RequestType.WEIXIN_PAY_CONFIRM_SHOP, null, catalogParam, _handler, HTTP_RESPONSE_PAY, MLPayServices.getInstance());
		loadDataWithMessage(WXPayEntryActivity.this,null,message1);
	}
