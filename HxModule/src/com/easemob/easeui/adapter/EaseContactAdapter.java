...
public class EaseContactAdapter extends ArrayAdapter<HxUser> implements SectionIndexer {
    ...
    private EaseContactListFragment.EaseContactsListItemAddClickListener mItemAddClickListener;

    public EaseContactAdapter(Context context, int resource, List<HxUser> objects,
                              EaseContactListFragment.EaseContactsListItemAddClickListener listener) {
        ...
        mItemAddClickListener = listener;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (res == 0)
                convertView = layoutInflater.inflate(R.layout.ease_row_contact1, null);
            else
                convertView = layoutInflater.inflate(res, null);
            holder.avatar = (ImageView) convertView.findViewById(R.id.avatar);
            holder.nameView = (TextView) convertView.findViewById(R.id.name);
            holder.headerView = (TextView) convertView.findViewById(R.id.header);
            holder.addView = (TextView) convertView.findViewById(R.id.unread_msg_add);
            convertView.setTag(holder);
        } else {
            holder = (ViewHolder) convertView.getTag();
        }

        final HxUser user = getItem(position);
        if (user == null)
            Log.d(TAG, "ContactAdapter:" + position);
        String username = user.name;
        String header = user.initialLetter;
        if (user.flag == 0) {
            ...
            holder.addView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mItemAddClickListener.onListItemAddClicked(user);
                }
            });
        }
        if (position == 0 || header != null && !header.equals(getItem(position - 1).initialLetter)) {
        ...
        //设置头像
        EaseUserUtils.setUserAvatar(getContext(), user.photo, holder.avatar);
    ...
    public Object[] getSections() {
        ...
        for (int i = 1; i < count; i++) {
            ...
            String letter = getItem(i).initialLetter;
            EMLog.d(TAG, "contactadapter getsection getHeader:" + letter + " name:" + getItem(i).name);
