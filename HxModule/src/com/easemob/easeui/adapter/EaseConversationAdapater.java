...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversation.EMConversationType.GroupChat) {
            // 群聊消息，显示群聊头像
            holder.avatar.setImageResource(R.drawable.qunzu);
          ...
          /*  EaseUserUtils.setUserAvatar(getContext(), username, holder.avatar);
            ...
            EaseUserUtils.setUserInfo(getContext(), username, holder.name, holder.avatar);
        }
    ...
    private class ConversationFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            List<EMConversation> emConversations = (List<EMConversation>) results.values;
