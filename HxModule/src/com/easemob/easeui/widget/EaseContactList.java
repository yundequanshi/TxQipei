...
public class EaseContactList extends RelativeLayout {
     ...
     * init view
     */
    public void init(List<HxUser> hxUser, EaseContactListFragment.EaseContactsListItemAddClickListener listener) {
        this.hxUser = hxUser;
        adapter = new EaseContactAdapter(context, 0, hxUser, listener);
    ...
    public void filter(CharSequence str) {
        if (adapter == null || adapter.getFilter() == null) return;
