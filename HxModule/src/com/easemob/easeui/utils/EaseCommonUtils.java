...
//              digest = EasyUtils.getAppResourceString(context, "location_prefix");
     ...
     * @param user
     */
    public static void setUserInitialLetter(HxUser user) {
        ...
        if (Character.isDigit(headerName.charAt(0))) {
            ...
            user.initialLetter=(HanziToPinyin.getInstance().get(headerName.substring(0, 1)).get(0).target.substring(0, 1)
                    .toUpperCase());
            char header = user.initialLetter.toLowerCase().charAt(0);
